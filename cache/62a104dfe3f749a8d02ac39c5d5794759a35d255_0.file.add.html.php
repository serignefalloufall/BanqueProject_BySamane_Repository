...
Compte/add" method="POST" class="formClient" id="formClient">
                ...
                <div class="itemFieldset">
                    <div>
                        ...
                        <select name="type_compte_id" id="selectCompte" onchange="myFunction()">
                            ...
                            <?php if (isset($_smarty_tpl->tpl_vars['listeTypeCompte']->value)) {?>
                            <?php if ($_smarty_tpl->tpl_vars['listeTypeCompte']->value != null) {?>
                            <?php
...
?>
                    ...
                    <div>   
                       ...
                       <input type='text' name='date_ouverture' id='date' value='<?php echo $_smarty_tpl->tpl_vars['today']->value;?>
' readonly/> 
                    ...
                    <div>
                        ...
                        <input type='text' name='num_compte' id='numCompte' value='<?php echo $_smarty_tpl->tpl_vars['numcompte']->value;?>
' readonly/>
                    ...
                    <div>
                        ...
                        <select name="agence_id" id="agence_id">
                            ...
                            <?php if (isset($_smarty_tpl->tpl_vars['listeAgence']->value)) {?>
                            <?php if ($_smarty_tpl->tpl_vars['listeAgence']->value != null) {?>
                            <?php
...
?>
                    ...
                    <div>
                        ...
                        <input type='text' name='cle_rip' id='cleRip' value='<?php echo $_smarty_tpl->tpl_vars['cleRip']->value;?>
' readonly />
                    </div>
