          ...
          <div class="itemFieldset">
            <div>
              ...
              >
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['listeTypeClient']->value)) {?> <?php if ($_smarty_tpl->tpl_vars['listeTypeClient']->value != null) {?>
                <?php
 ...
 <?php } else { ?> Liste vide <?php }?> <?php }?>
            ...
            <div id="listeEmployeur" class="listeEmployeur">
              ...
              <select name="employeur_id" id="employeur_id">
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['listeEmployeur']->value)) {?> <?php if ($_smarty_tpl->tpl_vars['listeEmployeur']->value != null) {?>
                <?php
